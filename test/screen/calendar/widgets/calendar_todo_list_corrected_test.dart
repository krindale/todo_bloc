...
void main() {
  group('CalendarTodoList', () {
    ...
    testWidgets('todo list is scrollable', (tester) async {
      ...
      final manyTodos = List.generate(20, (index) => 
        TodoEntity(
          ...
          dueDate: testDate,
          priority: [TodoPriority.high, TodoPriority.medium, TodoPriority.low][index % 3],
          category: [TodoCategory.work, TodoCategory.personal, TodoCategory.health][index % 3],
    ...
    /// 엣지 케이스: 빈 제목 Todo 테스트
    testWidgets('handles todos with empty titles gracefully', (tester) async {
      final edgeCaseTodos = [
        TodoEntity(
          id: '1',
          title: '', // 빈 제목
